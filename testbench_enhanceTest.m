function out = testbench_enhanceTest
% TESTBENCH_ENHANCETEST Exercise audio plugin class
% to check for violations of plugin constraints and other errors.
%
% OUT = TESTBENCH_ENHANCETEST Return the output data from the
...
%
%   codegen testbench_enhanceTest    % Create the mex function
%   testbench_enhanceTest_mex        % Run the mex function
%
...
% validateAudioPlugin.
%
% Automatically generated by validateAudioPlugin 08-Jun-2025 10:54:52 UTC-04:00
...
for sampleRate = sampleRates
    ...
    reset(plugin);
    checkForTampering(plugin, sampleRate, 'Resetting plugin');
